    ...
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
		  <div id="header-group_up">
			<div class="facebook">
				<a href="http://www.facebook.com/pages/heshbonaimcoil-%D7%97%D7%A9%D7%91%D7%95%D7%A0%D7%A2%D7%99%D7%9D/156124911108221" target="_blank">עקבו אחרינו</a>
			</div>
		  </div>
      ...
      <div id="main-wrapper" class="main-wrapper full-width">
        <div id="main" class="main row <?php print $grid_width; ?>">
          <div id="main-inner" class="main-inner inner clearfix">
            ...
            <div id="home-main-group" class="main-group row nested <?php print $main_group_width; ?>">
                      ...
                      <div id="content-group-inner" class="content-group-inner inner">
                        ...
                        <div id="content-region" class="content-region row nested">
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <div id="home_content-inner" class="home_content-inner block">
                              <div id="home-content-inner-inner" class="content-inner-inner inner">
                                <?php if ($title): ?>
